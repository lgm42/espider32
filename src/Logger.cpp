...
{ 
  ...
  if (telnetClient && telnetClient.connected() && telnetClient.available())
  {
    ...
    println("=====================================================");
    println(String("WS281X Controller - Build: ") + F(__DATE__) + " " +  F(__TIME__));
    println(String("WS281X Controller - Version: ") + String(VERSION));
    println("=====================================================");
    println();
  }
}
